                ...
                <div class="row">
                    <div>
                        ...
                        <?php else: 
                            ...
                            <div style="padding-bottom: 14px" class="col-md-12">
                                <div class="card horizontal">
                                    ...
                                    <div class="card-action ">
                                        <ul class="col-md-4">
                                                ...
                                                <ul class="col-md-4">
                                                <li><h6>Lessons</h6></li>
                                                <?php $sql = "select id from chapter where course_id = ".$row['id'];
                                                $result2 = mysqli_query($db,$sql);
                                                $count_chap = mysqli_num_rows($result2);

                                                ?>
                                                <li class="stata"><?=$count_chap;?></li>
                                                </ul>
                                                <ul class="col-md-4">
                                                <li><h6>Quizzes</h6></li>
                                                <li class="stata">0</li>
